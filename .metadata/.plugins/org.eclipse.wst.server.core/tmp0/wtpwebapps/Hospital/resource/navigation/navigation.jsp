						...
						<ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
							...
							<li class="has-children"><a href="#ourcenters"> <span
								...
								<ul class="dropdown arrow-top">
									<li><a href="index.jsp">Colombo</a></li>
									<li><a href="index.jsp">Nugegoda</a></li>
									<li><a href="index.jsp">Aluthgama</a></li>
									<li><a href="index.jsp">Mathara</a></li>
									<li><a href="index.jsp">Jaffna</a></li>
								</ul></li>
							...
							<li class="has-children"><a href="#doctors"><span>Doctors</span></a>
								<ul class="dropdown arrow-top">
									...
									<%
								   for(int i=0; i<=5; i++){
								   %><li style="width: 300px; height: auto;"><a href="#"">Dr. Savindu Pasintha - colombo</a></li>
									<%
								   }
								   %>
